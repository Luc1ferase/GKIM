...
### Task 5.2 (companion-memory-and-preset): Add `MemoryPanelRoute.kt` + `MemoryPanelViewModel` with `MemoryPanelPresentationTest` covering summary render, pin CRUD, and confirm-gated reset scopes. (commit `<pending>`)
