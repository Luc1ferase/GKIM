...
### Task 7.2 (companion-memory-and-preset): Aggregate `:app:connectedDebugAndroidTest` evidence on codex_api34 for `PresetLibraryInstrumentationTest` + `MemoryAndPresetIntegrationTest`. (commit `<pending>`)
