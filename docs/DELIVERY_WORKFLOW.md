...
### Task 4.3 (companion-memory-and-preset): Add `PresetLibraryInstrumentationTest` on codex_api34 covering create / edit / duplicate / activate / delete flows. (commit `<pending>`)
