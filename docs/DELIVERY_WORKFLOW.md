...
### Task 5.1 (companion-memory-and-preset): Add chat chrome primitives — `ChatChromePresetPill` + `ChatChromeMemoryEntry` factories — with `ChatChromePresentationTest` coverage. (commit `<pending>`)
