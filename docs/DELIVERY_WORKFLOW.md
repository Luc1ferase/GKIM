...
### Task 4.1 (companion-memory-and-preset): Add Settings → Presets section with `PresetLibraryViewModel` + `SettingsPresetsScreen` + `PresetListPresentationTest`. (commit `<pending>`)
