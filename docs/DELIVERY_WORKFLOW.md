...
### Task 5.2 (companion-settings-and-safety-reframe): Cross-reference design.md § "Per-terminal bubble copy + actions" from the spec delta so the backend/client contract is unambiguous. (commit `<pending>`)
