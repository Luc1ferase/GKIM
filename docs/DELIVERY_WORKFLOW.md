...
### Task 4.2 (companion-memory-and-preset): Add `PresetEditorRoute.kt` + `PresetEditorViewModel` + `PresetValidation` helper, wired into Settings PresetEditor destination. (commit `<pending>`)
