...
### Task 6.2 (companion-memory-and-preset): Document allocator integration + canonical built-in preset template content in design.md, and re-validate strict spec. (commit `<pending>`)
