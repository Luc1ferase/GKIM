...
### Task 7.1 (companion-settings-and-safety-reframe): Confirm all focused unit suites green in one full `:app:testDebugUnitTest --rerun-tasks` pass. (commit `<pending>`)
