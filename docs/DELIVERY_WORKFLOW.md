...
### Task 3.1 (companion-settings-and-safety-reframe): Reorganize `SettingsRoute.kt` menu into the six sections (Companion / Appearance / Content & Safety / AIGC Image Provider / Developer & Connection / Account) with renamed bilingual labels + section captions + DEBUG-gated Developer & Connection. (commit `<pending>`)
