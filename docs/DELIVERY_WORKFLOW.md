...
### Task 5.1 (companion-settings-and-safety-reframe): Finalize spec delta to cover block-reason closed set, failure-subtype closed set, and content-policy acknowledgment endpoints — `openspec validate --strict` green. (commit `<pending>`)
